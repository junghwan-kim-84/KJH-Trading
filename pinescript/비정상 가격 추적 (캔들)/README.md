...
| 단계 | 의미 | 대표 알림 |
| --- | --- | --- |
| 0단계 | 자리가 만들어지기 시작함 | `롱 자리 - 과매도 시작`, `숏 자리 - 과매수 시작` |
| 1단계 | 힘이 약해지는 힌트가 나옴 | `롱 힌트 - 하락 힘 약해짐`, `숏 힌트 - 상승 힘 약해짐` |
| 2단계 | 실제 감시할 배경 구간이 형성됨 | `롱 감시`, `숏 감시`, `롱 감시 강화`, `숏 감시 강화` |
| 3단계 | 첫 진입 신호가 나옴 | `롱 진입 후보 - 첫 진입 신호`, `숏 진입 후보 - 첫 진입 신호` |
| 4단계 | 유동성 스윕 뒤 확인까지 끝남 | `롱 확인 - 하단 유동성 스윕`, `숏 확인 - 상단 유동성 스윕` |
...
- `2단계 롱 감시 - 매수 배경 진입`
- `2단계 숏 감시 - 매도 배경 진입`
- `2단계 롱 감시 강화 - 매수 배경 강화`
- `2단계 숏 감시 강화 - 매도 배경 강화`
- `3단계 롱 진입 후보 - 첫 진입 신호`
- `3단계 숏 진입 후보 - 첫 진입 신호`
- `4단계 롱 확인 - 하단 유동성 스윕`
- `4단계 숏 확인 - 상단 유동성 스윕`
